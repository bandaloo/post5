...
})()(
  {
    1: [
      function (require, module, exports) {
            ...
            super(
              [
                ...(!useDepth
                  ? [
                      merge_pass_1
                        .loop([merge_pass_1.channel(samplerNum)])
                        .target(samplerNum),
                    ]
                  : []),
        ...
        function blurandtrace(
          brightness = merge_pass_1.mut(1),
          blurSize = merge_pass_1.mut(1),
      reps = 4,
          taps = 9,
          samplerNum = 0,
          useDepth = false
          ...
          return new BlurAndTrace(
            merge_pass_1.wrapInValue(brightness),
            merge_pass_1.wrapInValue(blurSize),
            reps,
            taps,
            samplerNum,
            useDepth
      ...
      function (require, module, exports) {
        ...
        class FoggyRaysExpr extends merge_pass_1.WrappedExpr {
          constructor(
            ...
            const fog = merge_pass_1.op(
              merge_pass_1.op(
                merge_pass_1.simplex(
                  merge_pass_1.op(
                    merge_pass_1.op(
                      merge_pass_1.pos(),
                      "+",
                      merge_pass_1.op(
                        merge_pass_1.op(merge_pass_1.time(), "*", speedFloat),
                        "/",
                        periodFloat
                      )
                    ),
                    "*",
                    merge_pass_1.op(
                      merge_pass_1.resolution(),
                      "/",
                      merge_pass_1.op(periodFloat, "*", 2)
                    )
                  )
                ),
                "*",
            ...
            const expr = merge_pass_1.godrays({
              weight: 0.009,
              density: merge_pass_1.op(
                throwDistanceFloat,
                "+",
                merge_pass_1.op(fog, "*", 0.5)
              ),
              convertDepth:
          ...
          setThrowDistance(throwDistance) {
            this.throwDistanceFloat.setVal(
              merge_pass_1.wrapInValue(throwDistance)
            );
        ...
        function foggyrays(
          period = merge_pass_1.mut(100),
          speed = merge_pass_1.mut(1),
          throwDistance = merge_pass_1.mut(0.3),
          numSamples = 100,
          samplerNum,
          convertDepthColor
        ) {
          return new FoggyRaysExpr(
            merge_pass_1.wrapInValue(period),
            merge_pass_1.wrapInValue(speed),
            merge_pass_1.wrapInValue(throwDistance),
            numSamples,
            samplerNum,
            convertDepthColor
      ...
      function (require, module, exports) {
        ...
        class Kaleidoscope extends merge_pass_1.WrappedExpr {
          constructor(sides, scale) {
            ...
            const tpos = merge_pass_1.op(
              merge_pass_1.translate(
                merge_pass_1.pos(),
                merge_pass_1.vec2(-0.5, -0.5)
              ),
              "/",
              scaleFloat
            );
            const angle = merge_pass_1.a2(
              "atan",
              merge_pass_1.getcomp(tpos, "y"),
              merge_pass_1.getcomp(tpos, "x")
            );
            const b = merge_pass_1.op(
              2 * Math.PI,
              "*",
              merge_pass_1.op(1, "/", sidesFloat)
            );
            const mangle = merge_pass_1.op(
              merge_pass_1.a1("floor", merge_pass_1.op(angle, "/", b)),
              "*",
              b
            );
            ...
            console.log("test!");
            const sign = merge_pass_1.a1(
              "floor",
              merge_pass_1.op(
                merge_pass_1.a2(
                  "mod",
                  merge_pass_1.op(mangle, "+", 0.1),
                  merge_pass_1.op(b, "*", 2)
                ),
                "/",
                b
            ...
            const spos = merge_pass_1.translate(
              merge_pass_1.rotate(
                tpos,
                merge_pass_1.op(mangle, "-", merge_pass_1.op(flip, "*", sign))
              ),
              merge_pass_1.vec2(0.5, 0.5)
            );
        ...
        function kaleidoscope(
          sides = merge_pass_1.mut(8),
          scale = merge_pass_1.mut(1)
        ) {
          return new Kaleidoscope(
            merge_pass_1.wrapInValue(sides),
            merge_pass_1.wrapInValue(scale)
          );
        }
        exports.kaleidoscope = kaleidoscope;
      },
      ...
      function (require, module, exports) {
        ...
        class LightBands extends merge_pass_1.WrappedExpr {
          constructor(speed, intensity, threshold, samplerNum) {
            ...
            const expr = merge_pass_1.brightness(
              merge_pass_1.ternary(
                merge_pass_1.op(
                  merge_pass_1.getcomp(merge_pass_1.channel(0), "r"),
                  "-",
                  thresholdFloat
                ),
                merge_pass_1.op(
                  merge_pass_1.a1(
                    ...
                    merge_pass_1.op(
                      merge_pass_1.op(merge_pass_1.time(), "*", speedFloat),
                      "+",
                      merge_pass_1.truedepth(
                        merge_pass_1.getcomp(
                          merge_pass_1.channel(samplerNum),
                          "r"
                        )
                      )
                    )
        ...
        function lightbands(
          speed = merge_pass_1.mut(4),
          intensity = merge_pass_1.mut(0.3),
          threshold = merge_pass_1.mut(0.01),
          samplerNum = 0
        ) {
          return new LightBands(
            merge_pass_1.wrapInValue(speed),
            merge_pass_1.wrapInValue(intensity),
            merge_pass_1.wrapInValue(threshold),
            samplerNum
          );
        }
        exports.lightbands = lightbands;
    ...
    6: [
      function (require, module, exports) {
          ...
          constructor(period, speed, intensity) {
            ...
            const noise = (comp) =>
              merge_pass_1.simplex(
                merge_pass_1.op(
                  merge_pass_1.op(
                    merge_pass_1.changecomp(
                      merge_pass_1.op(merge_pass_1.pos(), "/", periodFloat),
                      merge_pass_1.op(merge_pass_1.time(), "*", speedFloat),
                      comp,
                      "+"
                    ),
                    ...
                    merge_pass_1.op(
                      merge_pass_1.resolution(),
                      "/",
                      merge_pass_1.getcomp(merge_pass_1.resolution(), "y")
                    )
                  ),
                  "+",
                  comp === "x" ? X_OFF : Y_OFF
            ...
            super(
              merge_pass_1.channel(
                -1,
                merge_pass_1.op(
                  merge_pass_1.op(
                    merge_pass_1.op(
                      merge_pass_1.vec2(noise("x"), noise("y")),
                      "*",
                      intensityFloat
                    ),
                    "*",
                    merge_pass_1.op(
                      merge_pass_1.get2comp(merge_pass_1.resolution(), "yx"),
                      "/",
                      merge_pass_1.getcomp(merge_pass_1.resolution(), "y")
                    )
                  ),
        ...
        function noisedisplacement(
          period = merge_pass_1.mut(0.1),
          speed = merge_pass_1.mut(1),
          intensity = merge_pass_1.mut(0.005)
        ) {
      ...
      function (require, module, exports) {
        ...
        class OldFilm extends merge_pass_1.WrappedExpr {
          constructor(speckIntensity, lineIntensity, grainIntensity) {
            ...
            const period = 1 / 3;
            const ftime = merge_pass_1.a1(
              "floor",
              merge_pass_1.op(merge_pass_1.time(), "*", 24)
            );
            const grainy = merge_pass_1.op(
              merge_pass_1.random(
                merge_pass_1.op(
                  merge_pass_1.pixel(),
                  "+",
                  merge_pass_1.a2("mod", merge_pass_1.op(ftime, "*", 99), 3000)
                )
              ),
              "*",
              grainIntensityFloat
            );
            const rpos = merge_pass_1.a2(
              "mod",
              merge_pass_1.op(
                merge_pass_1.pos(),
                "+",
                merge_pass_1.random(merge_pass_1.vec2(ftime, 0))
              ),
              merge_pass_1.vec2(100, 100)
            );
            const lines = merge_pass_1.op(
              merge_pass_1.a2(
                "pow",
                merge_pass_1.a1(
                  "sin",
                  merge_pass_1.getcomp(merge_pass_1.op(rpos, "/", period), "x")
                ),
                3000
              ),
              "*",
              merge_pass_1.op(
                merge_pass_1.op(
                  merge_pass_1.random(merge_pass_1.vec2(ftime, 0)),
                  "*",
                  merge_pass_1.op(lineIntensityFloat, "*", -1)
                ),
                "+",
                merge_pass_1.op(lineIntensityFloat, "/", 4)
              )
            );
            const spos = merge_pass_1.a2(
              "mod",
              merge_pass_1.op(
                merge_pass_1.op(
                  merge_pass_1.pos(),
            ...
            const fsimplex = merge_pass_1.op(
              merge_pass_1.op(
                merge_pass_1.simplex(merge_pass_1.op(spos, "*", 7)),
                "*",
                0.44
              ),
              "+",
            ...
            const spots = merge_pass_1.op(
              merge_pass_1.a2("step", fsimplex, 0.08),
              "*",
              speckIntensityFloat
            );
            super(
              merge_pass_1.monochrome(
                merge_pass_1.brightness(
                  spots,
                  merge_pass_1.brightness(
                    lines,
                    merge_pass_1.brightness(grainy)
                  )
                )
              )
            );
          ...
          setSpeckIntensity(speckIntensity) {
            this.speckIntensityFloat.setVal(
              merge_pass_1.wrapInValue(speckIntensity)
            );
            this.speckIntensity = merge_pass_1.wrapInValue(speckIntensity);
          }
          setLineIntensity(lineIntensity) {
            this.lineIntensityFloat.setVal(
              merge_pass_1.wrapInValue(lineIntensity)
            );
            this.lineIntensity = merge_pass_1.wrapInValue(lineIntensity);
          }
          setGrainIntensity(grainIntensity) {
            this.grainIntensityFloat.setVal(
              merge_pass_1.wrapInValue(grainIntensity)
            );
        ...
        function oldfilm(
          speckIntensity = merge_pass_1.mut(0.4),
          lineIntensity = merge_pass_1.mut(0.25),
          grainIntensity = merge_pass_1.mut(0.11)
        ) {
          return new OldFilm(
            merge_pass_1.wrapInValue(speckIntensity),
            merge_pass_1.wrapInValue(lineIntensity),
    ...
    8: [
      ...
      { "./index": 3, "@bandaloo/merge-pass": 61 },
    ],
    9: [
      function (require, module, exports) {
        "use strict";
        ...
        class Vignette extends merge_pass_1.EffectLoop {
          constructor(blurScalar, brightnessScalar, brightnessExponent) {
            ...
            const brightnessExponentFloat = merge_pass_1.float(
              brightnessExponent
            );
            const blurLen = merge_pass_1.op(
              merge_pass_1.len(merge_pass_1.center()),
              "*",
              blurScalarFloat
            );
            const blurExpr = merge_pass_1.blur2d(blurLen, blurLen);
            const brightLen = merge_pass_1.a2(
              "pow",
              merge_pass_1.len(merge_pass_1.center()),
              brightnessExponentFloat
            );
            const brightExpr = merge_pass_1.brightness(
              merge_pass_1.op(
                brightLen,
                "*",
                merge_pass_1.op(brightnessScalarFloat, "*", -1)
              )
            );
          ...
          setBrightnessScalar(brightnessScalar) {
            this.brightnessScalarFloat.setVal(
              merge_pass_1.wrapInValue(brightnessScalar)
            );
            this.brightnessScalar = merge_pass_1.wrapInValue(brightnessScalar);
          }
          setBrightnessExponent(brightnessExponent) {
            this.brightnessExponentFloat.setVal(
              merge_pass_1.wrapInValue(brightnessExponent)
            );
            this.brightnessExponent = merge_pass_1.wrapInValue(
              brightnessExponent
            );
          }
        }
        ...
        function vignette(
          blurScalar = merge_pass_1.mut(3),
          brightnessScalar = merge_pass_1.mut(1.8),
          brightnessExponent = merge_pass_1.mut(1.8)
        ) {
          return new Vignette(
            merge_pass_1.wrapInValue(blurScalar),
            merge_pass_1.wrapInValue(brightnessScalar),
            merge_pass_1.wrapInValue(brightnessExponent)
          );
        }
...
uniform mediump vec2 uResolution;\n`;
        ...
        class CodeBuilder {
          constructor(effectLoop) {
            ...
            for (const name in buildInfo.uniformTypes) {
              ...
              this.uniformDeclarations.add(
                `uniform mediump ${typeName} ${name};`
              );
            }
            // add all external functions from the `BuildInfo` instance
            buildInfo.externalFuncs.forEach((func) =>
              this.externalFuncs.add(func)
            );
          ...
          compileProgram(gl, vShader, uniformLocs, shaders = []) {
            ...
            const fullCode =
              ...
              this.calls.join("\n") +
              "\n}";
            if (settings_1.settings.verbosity > 0) console.log(fullCode);
            ...
            return new webglprogramloop_1.WebGLProgramLoop(
              new webglprogramloop_1.WebGLProgramLeaf(
                program,
                this.totalNeeds,
                this.exprs
              ),
      ...
      { "./exprs/expr": 24, "./settings": 63, "./webglprogramloop": 65 },
    ],
    11: [
      function (require, module, exports) {
        "use strict";
      ...
      function (require, module, exports) {
        ...
        class Arity2HomogenousExpr extends expr_1.Operator {
          constructor(name, val1, val2) {
            super(val1, genArity1SourceList(name, val1, val2), [
              "uVal1",
              "uVal2",
            ]);
            this.val1 = val1;
        ...
        function a2(name, val1, val2) {
          return new Arity2HomogenousExpr(
            name,
            expr_1.wrapInValue(val1),
            expr_1.wrapInValue(val2)
          );
        }
        exports.a2 = a2;
      },
    ...
    13: [
      function (require, module, exports) {
        ...
        class BloomLoop extends mergepass_1.EffectLoop {
          constructor(
            threshold = expr_1.float(expr_1.mut(0.4)),
            horizontal = expr_1.float(expr_1.mut(1)),
            vertical = expr_1.float(expr_1.mut(1)),
            boost = expr_1.float(expr_1.mut(1.3)),
            samplerNum = 1,
            taps = 9,
            reps = 3
          ) {
            const bright = expr_1.cfloat(
              expr_1.tag`((${channelsampleexpr_1.channel(
                samplerNum
              )}.r + ${channelsampleexpr_1.channel(
                samplerNum
              )}.g + ${channelsampleexpr_1.channel(samplerNum)}.b) / 3.)`
            );
            const step = arity2_1.a2("step", bright, threshold);
            const col = expr_1.cvec4(
              expr_1.tag`vec4(${channelsampleexpr_1.channel(
                samplerNum
              )}.rgb * (1. - ${step}), 1.)`
            );
            const list = [
              ...
              opexpr_1.op(
                ...
                "+",
                channelsampleexpr_1.channel(samplerNum)
              ),
            ];
            super(list, { num: 1 });
            this.threshold = threshold;
        ...
        function bloom(
          ...
          return new BloomLoop(
            expr_1.wrapInValue(threshold),
            expr_1.wrapInValue(horizontal),
            expr_1.wrapInValue(vertical),
            expr_1.wrapInValue(boost),
            samplerNum,
            taps,
            reps
          );
    ...
    14: [
      function (require, module, exports) {
        ...
        class Blur2dLoop extends mergepass_1.EffectLoop {
          constructor(
            ...
            const side = blurexpr_1.gauss(
              vecexprs_1.vec2(horizontal, 0),
              taps,
              samplerNum
            );
            const up = blurexpr_1.gauss(
              vecexprs_1.vec2(0, vertical),
              taps,
              samplerNum
            );
        ...
        function blur2d(horizontalExpr, verticalExpr, reps, taps, samplerNum) {
          return new Blur2dLoop(
            expr_1.wrapInValue(horizontalExpr),
            expr_1.wrapInValue(verticalExpr),
            reps,
            taps,
            samplerNum
          );
      ...
      { "../mergepass": 62, "./blurexpr": 15, "./expr": 24, "./vecexprs": 58 },
    ],
    15: [
      function (require, module, exports) {
        "use strict";
    ...
    16: [
      function (require, module, exports) {
        ...
        class Brightness extends expr_1.ExprVec4 {
          constructor(brightness, col = fragcolorexpr_1.fcolor()) {
            super(expr_1.tag`brightness(${brightness}, ${col})`, [
              "uBrightness",
              "uColor",
            ]);
            this.brightness = brightness;
      ...
      { "../glslfunctions": 60, "./expr": 24, "./fragcolorexpr": 25 },
    ],
    17: [
      function (require, module, exports) {
        "use strict";
  ...
  return col;
        ...
        function checkChangeComponents(comps, setter, vec) {
          ...
          if (
            comps.length !==
            getcompexpr_1.typeStringToLength(setter.typeString())
          ) {
            throw new Error(
      ...
      function (require, module, exports) {
        ...
        function genChannelSampleSource(buf, coord) {
          return {
            sections: [
              "channel(",
              `, ${codebuilder_1.channelSamplerName(buf)})`,
            ],
            values: [coord],
          };
        }
    ...
    20: [
      function (require, module, exports) {
        ...
        class DepthToOcclusionExpr extends expr_1.ExprVec4 {
          constructor(
            depthCol = channelsampleexpr_1.channel(0),
            newCol = expr_1.mut(vecexprs_1.pvec4(1, 1, 1, 1)),
            threshold = expr_1.mut(expr_1.pfloat(0.01))
          ) {
            super(
              expr_1.tag`depth2occlusion(${depthCol}, ${newCol}, ${threshold})`,
              ["uDepth", "uNewCol", "uThreshold"]
            );
        ...
        function depth2occlusion(depthCol, newCol, threshold) {
          return new DepthToOcclusionExpr(
            depthCol,
            newCol,
            expr_1.wrapInValue(threshold)
          );
      ...
      { "./channelsampleexpr": 18, "./expr": 24, "./vecexprs": 58 },
    ],
    21: [
      function (require, module, exports) {
        "use strict";
        ...
        class DoFLoop extends mergepass_1.EffectLoop {
          constructor(
            depth = expr_1.mut(expr_1.pfloat(0.3)),
            rad = expr_1.mut(expr_1.pfloat(0.01)),
            depthInfo = getcompexpr_1.getcomp(
              channelsampleexpr_1.channel(0),
              "r"
            ),
            reps = 2,
            taps = 13
            ...
            const side = blurexpr_1.gauss(
              vecexprs_1.vec2(
                arity2_1.a2("pow", opexpr_1.op(1, "-", guassianExpr), 4),
                0
              ),
              taps
            );
        ...
        function dof(depth, rad, depthInfo, reps) {
          return new DoFLoop(
            expr_1.wrapInValue(depth),
            expr_1.wrapInValue(rad),
            expr_1.wrapInValue(depthInfo),
            reps
          );
        }
        exports.dof = dof;
      ...
      function (require, module, exports) {
        ...
        class EdgeColorExpr extends expr_1.WrappedExpr {
          constructor(color, samplerNum, stepped = true) {
            const expr = stepped
              ? expr_1.cvec4(
                  expr_1.tag`mix(${color}, ${fragcolorexpr_1.fcolor()}, ${monochromeexpr_1.monochrome(
                    arity2_1.a2(
                      "step",
                      vecexprs_1.vec4(0.5, 0.5, 0.5, 0.0),
      ...
      function (require, module, exports) {
        ...
        class EdgeExpr extends expr_1.WrappedExpr {
          constructor(mult = expr_1.mut(-1.0), samplerNum) {
            const operator = opexpr_1.op(
              getcompexpr_1.getcomp(
                invertexpr_1.invert(
                  monochromeexpr_1.monochrome(sobelexpr_1.sobel(samplerNum))
                ),
                "r"
              ),
              "*",
    ...
    24: [
      function (require, module, exports) {
        ...
        class Expr {
          ...
          setUniform(name, newVal) {
            ...
            if (
              ((_a = this.uniformValChangeMap[name]) === null || _a === void 0
                ? void 0
                : _a.val) === undefined
            ) {
            ...
            const oldVal =
              (_b = this.uniformValChangeMap[name]) === null || _b === void 0
                ? void 0
                : _b.val;
            if (oldVal === undefined) {
              throw new Error(
            ...
            if (oldVal.typeString() !== newVal.typeString()) {
              throw new Error(
                "tried to set uniform " + name + " to a new type"
              );
            }
          ...
          parse(buildInfo) {
            ...
            buildInfo.needs = webglprogramloop_1.updateNeeds(
              buildInfo.needs,
              this.needs
            );
            // add each of the external funcs to the builder
            this.externalFuncs.forEach((func) =>
              buildInfo.externalFuncs.add(func)
            );
            ...
            for (let i = 0; i < this.sourceLists.values.length; i++) {
              this.sourceCode +=
                ...
                this.sourceLists.values[i].parse(
                  buildInfo,
                  this.defaultNames[i],
                  this
                );
        ...
        function cfloat(sourceLists, externalFuncs = []) {
          return new ExprFloat(
            sourceLists,
            genCustomNames(sourceLists)
          ).addFuncs(externalFuncs);
        }
        ...
        class BasicVec extends Expr {
          ...
          setComp(index, primitive) {
            ...
            this.setUniform(
              this.defaultNames[index] + this.id,
              wrapInValue(primitive)
            );
          }
        }
        ...
        function float(value) {
          ...
          return new BasicFloat({ sections: ["", ""], values: [value] }, [
            "uFloat",
          ]);
        }
        exports.float = float;
        ...
        class ExprVec4 extends ExprVec {
          ...
          genPrograms(gl, vShader, uniformLocs, shaders) {
            return new mergepass_1.EffectLoop([this], { num: 1 }).genPrograms(
              gl,
              vShader,
              uniformLocs,
              shaders
      ...
      { "../mergepass": 62, "../utils": 64, "../webglprogramloop": 65 },
    ],
    25: [
      function (require, module, exports) {
        "use strict";
    ...
    28: [
      function (require, module, exports) {
        ...
        class GaussianExpr extends expr_1.ExprFloat {
          constructor(x, a, b) {
            super(expr_1.tag`gaussian(${x}, ${a}, ${b})`, [
              "uFloatX",
              "uFloatA",
              "uFloatB",
            ]);
        ...
        function gaussian(x, a = 0, b = 1) {
          return new GaussianExpr(
            expr_1.wrapInValue(x),
            expr_1.wrapInValue(a),
            expr_1.wrapInValue(b)
          );
        }
    ...
    30: [
      function (require, module, exports) {
        ...
        class GodRaysExpr extends expr_1.ExprVec4 {
          ...
          constructor(
            col = fragcolorexpr_1.fcolor(),
            exposure = expr_1.mut(1.0),
            decay = expr_1.mut(1.0),
            density = expr_1.mut(1.0),
            weight = expr_1.mut(0.01),
            lightPos = expr_1.mut(vecexprs_1.pvec2(0.5, 0.5)),
            samplerNum = 0,
            ...
            const sourceLists = expr_1.tag`${col}, ${exposure}, ${decay}, ${density}, ${weight}, ${lightPos}, ${
              convertDepth !== undefined
                ? convertDepth.threshold
                : expr_1.float(0)
            }, ${
              convertDepth !== undefined
                ? convertDepth.newColor
                : vecexprs_1.vec4(0, 0, 0, 0)
            })`;
            // TODO make this more generic
            // append the _<num> onto the function name
            // also add _depth if this is a version of the function that uses depth buffer
            const customName = `godrays${
            ...
            this.threshold =
              convertDepth === null || convertDepth === void 0
                ? void 0
                : convertDepth.threshold;
            this.newColor =
              convertDepth === null || convertDepth === void 0
            ...
            if (convertDepth !== undefined) {
              ...
              // does...)
              customGodRayFunc = customGodRayFunc.replace(
                /\/\/uncomment\s/g,
                ""
              );
              this.externalFuncs.push(
                glslfunctions_1.glslFuncs.depth2occlusion
              );
            }
        ...
        function godrays(options = {}) {
          return new GodRaysExpr(
            options.color,
            expr_1.wrapInValue(options.exposure),
            expr_1.wrapInValue(options.decay),
            expr_1.wrapInValue(options.density),
            expr_1.wrapInValue(options.weight),
            options.lightPos,
            options.samplerNum,
            options.numSamples,
    ...
    31: [
      function (require, module, exports) {
        ...
        class GrainExpr extends expr_1.ExprVec4 {
          constructor(grain) {
            super(
              expr_1.tag`vec4((1.0 - ${grain} * random(gl_FragCoord.xy)) * gl_FragColor.rgb, gl_FragColor.a);`,
              ["uGrain"]
            );
            this.grain = grain;
      ...
      function (require, module, exports) {
        ...
        class MotionBlurLoop extends mergepass_1.EffectLoop {
          constructor(target = 0, persistence = expr_1.float(expr_1.mut(0.3))) {
            const col1 = opexpr_1.op(
              channelsampleexpr_1.channel(target),
              "*",
              persistence
            );
            const col2 = opexpr_1.op(
              fragcolorexpr_1.fcolor(),
              "*",
              opexpr_1.op(1, "-", persistence)
            );
            const effects = [
    ...
    42: [
      function (require, module, exports) {
        ...
        function op(left, op, right) {
          return new OpExpr(
            expr_1.wrapInValue(left),
            op,
            expr_1.wrapInValue(right)
          );
        }
        exports.op = op;
      },
    ...
    43: [
      function (require, module, exports) {
        ...
        class PerlinExpr extends expr_1.ExprFloat {
          ...
          constructor(pos) {
            ...
            this.pos = pos;
            this.externalFuncs = [
              glslfunctions_1.glslFuncs.random2,
              glslfunctions_1.glslFuncs.gradientnoise,
            ];
          }
        ...
        function fractalize(pos, octaves, func) {
          ...
          const recurse = (pos, size, level) => {
            if (level <= 0) return expr_1.pfloat(0);
            return opexpr_1.op(
              func(opexpr_1.op(pos, "/", size * 2)),
              "+",
      ...
      { "../glslfunctions": 60, "./expr": 24, "./opexpr": 42 },
    ],
    44: [
      function (require, module, exports) {
        "use strict";
        ...
        class PowerBlurLoop extends mergepass_1.EffectLoop {
          constructor(size) {
            const side = blurexpr_1.gauss(
              expr_1.mut(vecexprs_1.pvec2(size, 0))
            );
    ...
    45: [
      ...
      { "../glslfunctions": 60, "./expr": 24, "./normfragcoordexpr": 40 },
    ],
    46: [
      function (require, module, exports) {
        "use strict";
        ...
        function createDifferenceFloats(floats) {
          ...
          for (let i = 0; i < 2; i++) {
            differences.push(
              opexpr_1.op(
                getcompexpr_1.getcomp(normfragcoordexpr_1.pos(), axes[i]),
                "-",
                floats[i]
              )
            );
          ...
          for (let i = 2; i < floats.length; i++) {
            differences.push(
              opexpr_1.op(
                floats[i],
                "-",
                getcompexpr_1.getcomp(normfragcoordexpr_1.pos(), axes[i - 2])
              )
            );
          }
          return differences;
      ...
      function (require, module, exports) {
        ...
        class SimplexNoise extends expr_1.ExprFloat {
          constructor(pos) {
            ...
            this.pos = pos;
            this.externalFuncs = [
              glslfunctions_1.glslFuncs.simplexhelpers,
              glslfunctions_1.glslFuncs.simplexnoise,
            ];
          }
          setPos(pos) {
            this.setUniform("uPos", pos);
      ...
      function (require, module, exports) {
        ...
        class TernaryExpr extends expr_1.Operator {
          constructor(floats, success, failure, not) {
            super(
              success,
              genTernarySourceList(floats, success, failure, not),
              [
                ...(floats !== null
        ...
        function ternary(floats, success, failure, not = false) {
          ...
          return new TernaryExpr(
            floats,
            expr_1.wrapInValue(success),
            expr_1.wrapInValue(failure),
            not
          );
        }
    ...
    58: [
      function (require, module, exports) {
        ...
        function vec2(comp1, comp2) {
          return new expr_1.BasicVec2(
            ...vecSourceList(
              ...[comp1, comp2].map((c) => expr_1.wrapInValue(c))
            )
          );
        }
        exports.vec2 = vec2;
        ...
        function vec3(comp1, comp2, comp3) {
          return new expr_1.BasicVec3(
            ...vecSourceList(
              ...[comp1, comp2, comp3].map((c) => expr_1.wrapInValue(c))
            )
          );
        }
        exports.vec3 = vec3;
        ...
        function vec4(comp1, comp2, comp3, comp4) {
          return new expr_1.BasicVec4(
            ...vecSourceList(
              ...[comp1, comp2, comp3, comp4].map((c) => expr_1.wrapInValue(c))
            )
          );
        }
        exports.vec4 = vec4;
  ...
  return texture2D(sampler, uv);
    ...
    61: [
      ...
      },
      {
        ...
        "./exprs/blur2dloop": 14,
        "./exprs/blurexpr": 15,
        "./exprs/brightnessexpr": 16,
        "./exprs/changecompexpr": 17,
        "./exprs/channelsampleexpr": 18,
        "./exprs/contrastexpr": 19,
        "./exprs/depthtoocclusionexpr": 20,
        "./exprs/dofloop": 21,
        "./exprs/edgecolorexpr": 22,
        "./exprs/edgeexpr": 23,
        "./exprs/expr": 24,
        "./exprs/fragcolorexpr": 25,
        "./exprs/fragcoordexpr": 26,
        "./exprs/fxaaexpr": 27,
        "./exprs/getcompexpr": 29,
        "./exprs/godraysexpr": 30,
        "./exprs/grainexpr": 31,
        "./exprs/hsvtorgbexpr": 32,
        "./exprs/invertexpr": 33,
        "./exprs/lenexpr": 34,
        "./exprs/monochromeexpr": 35,
        "./exprs/motionblurloop": 36,
        "./exprs/mouseexpr": 37,
        "./exprs/normcenterfragcoordexpr": 38,
        "./exprs/normexpr": 39,
        "./exprs/normfragcoordexpr": 40,
        "./exprs/normmouseexpr": 41,
        "./exprs/opexpr": 42,
        "./exprs/perlinexpr": 43,
        "./exprs/powerblur": 44,
        "./exprs/randomexpr": 45,
        "./exprs/regiondecorator": 46,
        "./exprs/resolutionexpr": 47,
        "./exprs/rgbtohsvexpr": 48,
        "./exprs/rotateexpr": 49,
        "./exprs/scenesampleexpr": 50,
        "./exprs/simplexexpr": 52,
        "./exprs/sobelexpr": 53,
        "./exprs/ternaryexpr": 54,
        "./exprs/timeexpr": 55,
        "./exprs/translateexpr": 56,
        "./exprs/truedepthexpr": 57,
        "./exprs/vecexprs": 58,
        "./exprtypes": 59,
        "./glslfunctions": 60,
        "./mergepass": 62,
      ...
      function (require, module, exports) {
        ...
        function wrapInSetColors(effects) {
          return effects.map((e) =>
            e instanceof expr_1.ExprVec4 || e instanceof EffectLoop
              ? e
              : new setcolorexpr_1.SetColorExpr(e)
          );
        }
        ...
        class EffectDictionary {
          ...
          toProgramMap(gl, vShader, uniformLocs, fShaders) {
            ...
            for (const name in this.effectMap) {
              ...
              while (!atBottom) {
                if (
                  currProgramLoop.programElement instanceof
                  webglprogramloop_1.WebGLProgramLeaf
                ) {
        ...
        class EffectLoop {
            ...
            const breakOff = () => {
              ...
              if (prevEffects.length > 0) {
                ...
                if (prevEffects.length === 1) {
                  ...
                  regroupedEffects.push(
                    new EffectLoop(prevEffects, { num: 1 })
                  );
                }
          ...
          genPrograms(gl, vShader, uniformLocs, shaders) {
            ...
            const restSampleNum =
              this.getSampleNum(undefined, 1) / this.loopInfo.num;
            if (
              !this.hasTargetSwitch() &&
              (fullSampleNum === 0 ||
                (firstSampleNum === 1 && restSampleNum === 0))
            ) {
            ...
            return new webglprogramloop_1.WebGLProgramLoop(
              this.effects.map((e) =>
                e.genPrograms(gl, vShader, uniformLocs, shaders)
              ),
              this.loopInfo,
              gl
            );
        ...
        class Merger {
          ...
          draw(timeVal = 0, mouseX = 0, mouseY = 0) {
            this.gl.activeTexture(
              this.gl.TEXTURE0 + settings_1.settings.offset
            );
            ...
            if (
              ...
              this.gl.activeTexture(
                this.gl.TEXTURE1 + settings_1.settings.offset
              );
            ...
            for (const b of this.channels) {
              ...
              this.gl.activeTexture(
                this.gl.TEXTURE2 + counter + settings_1.settings.offset
              );
              this.gl.bindTexture(
                this.gl.TEXTURE_2D,
          ...
          delete() {
            ...
            for (let i = 0; i < 2 + this.tex.bufTextures.length; i++) {
              ...
              this.gl.activeTexture(
                this.gl.TEXTURE0 + i + settings_1.settings.offset
              );
              this.gl.bindTexture(this.gl.TEXTURE_2D, null);
            }
        ...
        function makeTexture(gl, options) {
          ...
          gl.texParameteri(
            ...
            filterMode(
              options === null || options === void 0
                ? void 0
                : options.maxFilterMode
            )
          );
          if (
            (options === null || options === void 0
              ? void 0
              : options.edgeMode) !== "wrap"
          ) {
            gl.texParameteri(
              gl.TEXTURE_2D,
              gl.TEXTURE_WRAP_S,
    ...
    64: [
      function (require, module, exports) {
        ...
        function nameExtractor(sourceLists, extra) {
          ...
          const ending =
            origFuncName[origFuncName.length - 1] === ")" ? ")" : "";
          const newFuncName =
            origFuncName.substr(
              0,
              origFuncName.length - 1 - ~~(ending === ")")
            ) +
            extra +
            "(" +
            ending;
        ...
        class WebGLProgramLoop {
          ...
          run(
            ...
            if (
              ...
              (outerLoop === null || outerLoop === void 0
                ? void 0
            ...
            if (this.programElement instanceof WebGLProgramLeaf) {
              ...
              if (
                ...
                this.counter++;
                const mod =
                  outerLoop === undefined ? 1 : outerLoop.loopInfo.num;
                this.counter %= mod;
              }
            }
            for (let i = 0; i < this.loopInfo.num; i++) {
              ...
              if (this.programElement instanceof WebGLProgramLeaf) {
                ...
                for (const n of this.programElement.totalNeeds.extraBuffers) {
                  gl.activeTexture(
                    gl.TEXTURE2 + n + settings_1.settings.offset
                  );
